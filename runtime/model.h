...
struct Inputs {
    ...
    int64_t          lingbot_latent_c    = 0;
    int64_t          lingbot_latent_f    = 0;
    ...
    const float*     lingbot_action_condition = nullptr;
    int64_t          lingbot_action_condition_c = 0;
    int64_t          lingbot_action_condition_f = 0;
    int64_t          lingbot_action_condition_h = 0;

    /// LingBot-VA cache controls. 0 = normal temporary query, 1 = prediction
    /// cache update, 2 = persistent history/cache prefill update.
    uint64_t         lingbot_session_id = 0;
    int              lingbot_cache_mode = 0;
    bool             lingbot_clear_pred_cache = false;
    bool             lingbot_first_chunk = false;
