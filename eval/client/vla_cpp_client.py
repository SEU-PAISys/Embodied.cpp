...
ARCH_PRESETS = {
    ...
    "hy_vla":  {"image_size": 224, "tokenizer": None, "max_state_dim": 20,
...
def _load_pb():
    ...
    if not proto_file.exists():
        raise FileNotFoundError(
            ...
            f"<vla.cpp>/serving/vla.proto location.")
...
class VlaCppClient:
    ...
    def __init__(
        ...
        *,
        ...
        tokenizer_kwargs = {}
        chat_template_path = Path(tokenizer_name) / "chat_template.jinja" if tokenizer_name else None
